...
const metrics = [
  { 
    ...
    sublabel: "websites & apps combined",
  },
  { 
    value: 100, 
    suffix: "%", 
...
export function MetricsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative pt-16 lg:pt-24 pb-8 lg:pb-12 overflow-hidden">
      <GridBackground />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            <div className="flex items-center gap-4 mb-6">
              <span className="flex items-center gap-2 px-3 py-1 bg-[#ff008c]/10 text-[#ff008c] text-xs font-mono">
                <span className="w-2 h-2 rounded-full bg-[#ff008c] animate-pulse" />
                LIVE
              </span>
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span>Node.js</span>
          <span className="text-foreground">+8 more technologies</span>
        </div>
      </div>
    </section>
  );
