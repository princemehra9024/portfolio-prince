...
const regions = [
  ...
  { name: "App Development", nodes: 4, status: "completed" },
  { name: "UI/UX Design", nodes: 30, status: "completed" },
  { name: "Consulting", nodes: 20, status: "completed" },
];
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground max-w-md">
                Freelancing experience delivering web solutions to satisfied clients across different industries.
              </p>
            </div>
          </div>
